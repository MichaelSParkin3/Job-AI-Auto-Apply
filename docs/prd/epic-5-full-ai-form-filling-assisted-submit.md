# Epic 5 ‚Äî Full AI Form Filling & Assisted Submit
...
## Story 5.1 ‚Äî LLM-Guided Form Plan Refinement
As a developer,
...
## Story 5.2 ‚Äî Headful Browser-Use Auto Fill Execution
As an operator,
...
## Story 5.2.1 ó Resume-First + Analysis Wait
As an operator, I want the agent to upload the resume first, wait for Leverís resume analysis (e.g., ëAnalyzingÖí ? ëSuccess!í) to complete, then validate and fill remaining fields before proceeding (submit if allowed).
...
## Story 5.3 ‚Äî Submit Attempt & Blocker Detection
...
## Story 5.4 ‚Äî Assisted Submit Relaunch & UI Workflow
As a reviewer,
...
Acceptance Criteria
1. Preview UI surfaces a ‚ÄúNeeds your help to submit‚Äù banner with CTA ‚ÄúResume in Browser‚Äù; clicking calls new endpoint `POST /api/run/{id}/handoff/{candidateId}/launch`.
...
## Story 5.5 ‚Äî History, Analytics & Proof Artifacts
