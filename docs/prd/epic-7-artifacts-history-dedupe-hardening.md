# Epic 7 — Artifacts, History & Dedupe Hardening
...
## Story 7.1 — Artifact Capture & Retention Controls
As an operator,
...
## Story 7.2 — History JSONL Append & Atomicity
As a developer,
...
## Story 7.3 — JD Capture & HTML Snapshot
As a user,
...
## Story 7.4 — Dedupe Policy Enforcement (30 Days)
As an applicant,
...
## Story 7.5 — Reliability Hardening & Fallbacks
As an operator,
